...
module.exports = {
        ...
        // onStart is a function that will be executed when has new event in group (see more at https://github.com/NethWs3Dev/ws3-fca (Event Type: "event"))
        onStart: async function ({ api, usersData, threadsData, message, event, userModel, threadModel, prefix, dashBoardModel, globalModel, dashBoardData, globalData, envCommands, envEvents, envGlobal, role, getLang , commandName }) {
                ...
                // check if event is user join group, see more at https://github.com/NethWs3Dev/ws3-fca
